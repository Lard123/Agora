...
On the business side of Agora, we plan to license the app to chapters. The current version is specifically for Cupertino FBLA. However, we can sell the source code of the app to other chapters and they can edit the components of it for their own purposes.
